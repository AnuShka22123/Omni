  ...
  return (
    <>
      ...
      <main className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
        <div className="pointer-events-none absolute inset-0 opacity-60 bg-[radial-gradient(circle_at_25%_15%,rgba(255,255,255,0.05),transparent_35%),radial-gradient(circle_at_80%_0%,rgba(99,102,241,0.07),transparent_30%)]" />
          ...
          {error ? (
            <div className="space-y-4">
              ...
              <button
                ...
                className="px-6 py-2 bg-dark-surface border border-dark-border rounded-sm hover:border-white transition-colors hover:-translate-y-0.5 transform focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
              >
                Go Back
              </button>
            </div>
